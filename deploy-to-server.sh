...
# LibreWXR API URL for weather radar tiles (use the public LibreWXR API)
export VITE_LIBREWXR_API_URL="https://api.librewxr.net/public/weather-maps.json"
echo "🌦️  LibreWXR radar API: $VITE_LIBREWXR_API_URL"
