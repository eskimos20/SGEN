...
const CAPACITOR_API_URL = import.meta.env.VITE_API_URL || 'http://YOUR_SERVER_IP:8081/api';
...
//    VITE_API_URL=http://YOUR_SERVER_IP:8081/api npm run build
// 3. For permanent config, add to your .env file:
//    VITE_API_URL=http://YOUR_SERVER_IP:8081/api
