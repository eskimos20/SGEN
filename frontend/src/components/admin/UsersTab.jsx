                  ...
                  <div key={user.id} className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className={user.mustChangePassword ? 'text-amber-600' : 'text-green-600'}>
                          {user.mustChangePassword ? 'Must change password' : 'Active'}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-500">Online</span>
                        <span className={`inline-flex items-center gap-1 ${isOnline ? 'text-green-600' : 'text-gray-400'}`}>
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-gray-500">Intervals.icu</span>
                        {user.hasIntervalsConfig ? (
                          <CheckCircle className="h-5 w-5 text-green-600" />
                        ) : (
                          <XCircle className="h-5 w-5 text-gray-400" />
