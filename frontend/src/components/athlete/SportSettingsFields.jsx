...
const SportSettingsFields = ({ 
  ...
  return (
    <>
        ...
        <div className="space-y-3 mb-4">
          <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              />
              <div
                className="w-9 h-5 bg-gray-300 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-blue-600"
                title="Use device/file laps instead of Intervals.icu's power interval detection"
              ></div>
            </label>
            <div>
          ...
          <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              <div
                className="w-9 h-5 bg-gray-300 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-blue-600"
                title="Keep every lap as an interval and skip Intervals.icu's cleanup heuristics"
              ></div>
            </label>
            <div>
      ...
      {/* Top row: FTP, Indoor FTP, Max HR, LTHR, Threshold Pace */}
      <div className={`grid gap-4 ${editForm.supportsPower ? 'grid-cols-1 sm:grid-cols-4' : 'grid-cols-1 sm:grid-cols-2'}`}>
        {editForm.supportsPower && (
          <div>
        ...
        {editForm.supportsPower && (
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Indoor FTP (W)</label>
            <input
              type="number"
              value={editForm.sportIndoorFtp}
              onChange={(e) => setEditForm(prev => ({ ...prev, sportIndoorFtp: e.target.value }))}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              placeholder="Defaults to FTP"
            />
          </div>
        )}
